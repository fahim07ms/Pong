...
static void  __stdcall iA0(HWND hwnd,UINT uMsg,UINT_PTR idEvent, DWORD dwTime){if(!iAnimPause[0])iAnimFunction[0]();}
static void  __stdcall iA1(HWND hwnd,UINT uMsg,UINT_PTR idEvent, DWORD dwTime){if(!iAnimPause[1])iAnimFunction[1]();}
static void  __stdcall iA2(HWND hwnd,UINT uMsg,UINT_PTR idEvent, DWORD dwTime){if(!iAnimPause[2])iAnimFunction[2]();}
static void  __stdcall iA3(HWND hwnd,UINT uMsg,UINT_PTR idEvent, DWORD dwTime){if(!iAnimPause[3])iAnimFunction[3]();}
static void  __stdcall iA4(HWND hwnd,UINT uMsg,UINT_PTR idEvent, DWORD dwTime){if(!iAnimPause[4])iAnimFunction[4]();}
static void  __stdcall iA5(HWND hwnd,UINT uMsg,UINT_PTR idEvent, DWORD dwTime){if(!iAnimPause[5])iAnimFunction[5]();}
static void  __stdcall iA6(HWND hwnd,UINT uMsg,UINT_PTR idEvent, DWORD dwTime){if(!iAnimPause[6])iAnimFunction[6]();}
static void  __stdcall iA7(HWND hwnd,UINT uMsg,UINT_PTR idEvent, DWORD dwTime){if(!iAnimPause[7])iAnimFunction[7]();}
static void  __stdcall iA8(HWND hwnd,UINT uMsg,UINT_PTR idEvent, DWORD dwTime){if(!iAnimPause[8])iAnimFunction[8]();}
static void  __stdcall iA9(HWND hwnd,UINT uMsg,UINT_PTR idEvent, DWORD dwTime){if(!iAnimPause[9])iAnimFunction[9]();}
